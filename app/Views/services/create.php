...
<main>
    <div class="page-header">
        <div>
            ...
            <p>Masukkan data layanan baru untuk ditampilkan di sistem.</p>
        </div>
    ...
    <div class="card-panel">
        <form action="<?= base_url('/admin/services/store') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control"><?= esc(old('description')) ?></textarea>
            </div>
            <div class="mb-3">
                <label class="form-label">Harga</label>
                <input type="number" step="0.01" name="price" class="form-control" value="<?= esc(old('price')) ?>" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Durasi (menit)</label>
                <input type="number" name="duration" class="form-control" value="<?= esc(old('duration')) ?>" required>
            </div>
            <div class="mb-3">
